...
- Added ContactForm Outreach and ReplyReddit foundation docs plus a sample CSV campaign template.
...
- Added Docker foundation for n8n, PostgreSQL, and Redis.
- Added initial Hermes n8n workflows.
- Added Hermes logger schema.
- Added baseline agent prompts.
- Added server deploy script and GitHub Actions deployment template.
